...
class ModernMahasiswaCard extends StatefulWidget {
  ...
  @override
  State<ModernMahasiswaCard> createState() => _ModernStatCardState();
}

class _ModernStatCardState extends State<ModernMahasiswaCard> with SingleTickerProviderStateMixin {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoRow(
                        ...
                        'Semester: ${widget.mahasiswa.angkatan}',
                      ),
                    ],
                  ),
                ),
...
class MahasiswaListView extends StatelessWidget {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (useModernCard) {
            ...
            return _buildSimpleCard(mahasiswa);
          }
        },
      ),
    );
  ...
  Widget _buildSimpleCard(MahasiswaModel mahasiswa) {
    return Card(
