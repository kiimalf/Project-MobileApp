...
class ModernDosenCard extends StatefulWidget {
  ...
  @override
  State<ModernDosenCard> createState() => _ModernStatCardState();
}

class _ModernStatCardState extends State<ModernDosenCard> with SingleTickerProviderStateMixin {
